...
Source8:    max_connections_module.tar.gz
...
./configure \
    ...
    --add-module=%{_builddir}/nginx-%{version}/max_connections_module
make %{?_smp_mflags} 
...
mv max_connections_module/README max_connections_module/README.max_connections_module
